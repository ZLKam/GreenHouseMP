...
public class Connection : MonoBehaviour
{
    ...
    void Connect()
    {
        ...
        //Instantiates both the pipes intended to be the beginning of the system and the end
        ...
        //uh wut
        Vector3 first = pipeEntrance.transform.position;
        Vector3 second = pipeExit.transform.position;
